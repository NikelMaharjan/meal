...
class MealDetailPage extends StatelessWidget {
  ...
  MealDetailPage(this.mealsCategory);

  @override
  Widget build(BuildContext context) {
    print(mealsCategory.id);
    return SafeArea(
      child: Scaffold(
        body: Consumer(builder: (context, ref, child) {
          final meal = ref.watch(mealProvider(mealsCategory.id));
          return meal.when(
              data: (data) {
              ...
              error: (err, stack) => (err as String).contains('No Internet.') ? ConnectionUI( () { ref.refresh(mealProvider(mealsCategory.id));}) : Center(child: Text('$err'),),
